    ...
    class TempusDominus {
        ...
        _keydown(e) {
            ...
            for (index in this.options.keyBinds) {
                if (this.options.keyBinds.hasOwnProperty(index) && typeof this.options.keyBinds[index] === 'function') {
        ...
        hide() { //todo jquery
            ...
            this.viewDate = lastPickedDate ? lastPickedDate.clone() : this.getMoment();
        }
        ...
        show() { //todo jquery moment
            ...
            if (this.input !== undefined) {
                if (this.input.prop('disabled') || !this.options.ignoreReadonly && this.input.prop('readonly') || this.widget) {
                    return;
                }
            ...
            if (shouldUseCurrentIfUnset && this.unset && this.options.useCurrent) {
                ...
                if (typeof this.options.useCurrent === 'string') {
                    currentMoment = useCurrentGranularity[this.options.useCurrent](currentMoment);
                }
            ...
            this._place();
            this.widget.show();
            if (this.input !== undefined && this.options.focusOnShow && !this.input.is(':focus')) {
                this.input.focus();
            }
