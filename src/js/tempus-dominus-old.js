...
//#region Constants
    ...
    const DatePickerModes = [{
        ...
        getSelectorFromElement = function ($element) {
            ...
            if (!$selector.data(DATA_KEY)) { //todo jquery
...
//#endregion
    ...
    class TempusDominus {
        ...
        _int() {
            ...
            if (this._element.hasClass('input-group')) {//todo jquery //todo bootstrap
        ...
        _getDatePickerTemplate() {//todo jquery cries in jquery
            const headTemplate = $('<thead>').append(
                $('<tr>').append(
                    ...
                    $('<th>').addClass('picker-switch').attr('data-action', 'pickerSwitch').attr('colspan', `${this._options.calendarWeeks ? '6' : '5'}`)
                )
                    .append(
                        $('<th>').addClass('next').attr('data-action', 'next')
                            .append(
        ...
        _getTimePickerMainTemplate() {//todo jquery cries in jquery
            const topRow = $('<tr>'),
                middleRow = $('<tr>'),
                bottomRow = $('<tr>');
        ...
        _getTimePickerTemplate() {//todo jquery cries in jquery
        ...
        _getToolbar() {//todo jquery cries in jquery
            const row = [];
        ...
        _getTemplate() {//todo jquery cries in jquery
        ...
        _fillDow() { //todo jquery todo moment
            const row = $('<tr>'),
        ...
        _fillMonths() { //todo jquery todo moment
            const spans = [],
        ...
        _updateMonths() { //todo jquery todo moment
        ...
        _updateYears() { //todo jquery moment
        ...
        _updateDecades() { //todo jquery moment
        ...
        _fillMinutes() { //todo jquery moment
        ...
        _fillSeconds() { //todo jquery moment
        ...
        _doAction(e, action) {
            ...
            switch (action) {
                case 'next': {
                    const navFnc = DatePickerModes[this.currentViewMode].NAV_FUNCTION;
                    this._viewDate.add(DatePickerModes[this.currentViewMode].NAV_STEP, navFnc);
                    this._fillDate();
                ...
                case 'previous': {
                    const navFnc = DatePickerModes[this.currentViewMode].NAV_FUNCTION;
                    this._viewDate.subtract(DatePickerModes[this.currentViewMode].NAV_STEP, navFnc);
                    this._fillDate();
                    this._viewUpdate(navFnc);
                    break;
                }
