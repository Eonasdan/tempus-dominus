...
export default class Display {
    ...
    private _buildSideBySide(template, dateView, timeView, toolbar) {
    ...
    private _buildDateView(): HTMLElement {
    ...
    private _buildTimeView(): HTMLElement {
