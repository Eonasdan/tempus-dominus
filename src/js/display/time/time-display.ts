...
export default class TimeDisplay {
    ...
    private _updateHour(timesDiv: HTMLElement, lastPicked: DateTime) {
        if (!this.optionsStore.options.display.components.hours) return;
        if (
    ...
    private _updateMinute(timesDiv: HTMLElement, lastPicked: DateTime) {
        if (!this.optionsStore.options.display.components.minutes) return;
    ...
    private _updateSecond(timesDiv: HTMLElement, lastPicked: DateTime) {
        if (!this.optionsStore.options.display.components.seconds) return;
    ...
    private _updateTwentyfour(timesDiv: HTMLElement, lastPicked: DateTime) {
        if (this.optionsStore.options.display.components.useTwentyfourHour) return;
